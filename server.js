...
const youtube = new YouTube("AIzaSyCsR2FnDqsOzb9inJU8UzpfgrZF6Mam6x0"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyCsR2FnDqsOzb9inJU8UzpfgrZF6Mam6x0"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("ready", () => {
  ...
  client.user.setActivity(`Developer OSTN on top`, { type: "WATCHING" });
});
